                ...
                <div>
                    <form>
                        <div className='my-[1.5rem] flex flex-col w-full'>
                            ...
                            <input onChange={(e) => setsubject(e.target.value)} id='subject' type='text' className='mt-[0.5rem] w-full h-[3rem] p-[1rem] bg-[#F5F5F5] rounded-[0.5rem] input-hover' />
                        </div>
                        ...
                        <div className='my-[1.5rem] flex flex-col w-full'>
                            ...
                            <input onChange={(e) => setname(e.target.value)} id='name' type='text' name='name' className='mt-[0.5rem] w-full h-[3rem] p-[1rem] bg-[#F5F5F5] rounded-[0.5rem] input-hover' />
                        </div>
                        ...
                        <div className='my-[1.5rem] flex flex-col w-full'>
                            ...
                            <input onChange={(e) => setemail(e.target.value)} id='email' type='text' className='mt-[0.5rem] w-full h-[3rem] p-[1rem] bg-[#F5F5F5] rounded-[0.5rem] input-hover' />
                        </div>
                        ...
                        <div className='my-[1.5rem] flex flex-col w-full'>
                            ...
                            <textarea onChange={(e) => setbody(e.target.value)} id='message' type='text' className='mt-[0.5rem] w-full h-[15rem] p-[1rem] bg-[#F5F5F5] rounded-[0.5rem] input-hover'></textarea>
                        </div>
